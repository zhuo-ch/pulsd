...
document.addEventListener('DOMContentLoaded', function () {
  ...
  _reactDom2.default.render(_react2.default.createElement(_admin2.default, null), root);
});
...
var _event_list = __webpack_require__(28);
...
var Admin = function (_React$Component) {
  ...
  _createClass(Admin, [{
    ...
    value: function componentDidMount() {
      var time = new Date();
      var timeZone = time.split(' ')[4].slice(0, 3);
